...
##        net = tf.nn.dropout(net, 0.5, name='drop1')
        pool_4 = net
...
##        net = tf.nn.dropout(net, 0.5, name='drop2')
        pool_5 = net
